...
#from Transmission import Transmission #erreur, fichier Transmission.py inexistant
from transmission import Transmission # correction, fichier transmission.py
