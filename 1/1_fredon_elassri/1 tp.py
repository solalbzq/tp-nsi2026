...
# Question 1 il peut y en avoir plus car si tout les pixels sont différents on peut avoir une liste 2 fois plus grande
#question 3:
# On exécute les deux commandes suivantes :
#encoder_decoder_image("bac_nsi_32.png")
#encoder_decoder_image("bac_nsi_256.png")
#L’image de 256 pixels est déformée, elle est applatie et allongée.
