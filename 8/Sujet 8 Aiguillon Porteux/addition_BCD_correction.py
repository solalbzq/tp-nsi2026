def calcul_recettes():
    ...
    i = 1
    total = 0
    while i = nb_restaurant:
        total = menu * nb_menu
        i  += 1
        
    return total
print("recette totale : " calcul_recettes())
...
print(convertir_BCD_vers_decimal(additionner_nombres_format_BCD('23', '4')))
...
print(convertir_BCD_en_decimal(additionner_nombres_formats_BCD('27', '35')))